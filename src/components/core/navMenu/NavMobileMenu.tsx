...
const NavMobileMenu = ({ isOpen, setIsOpen, isClosing, setIsClosing, children }: { isOpen: boolean; setIsOpen: Dispatch<SetStateAction<boolean>>; isClosing: boolean; setIsClosing: Dispatch<SetStateAction<boolean>>; children: React.ReactNode[] }) => {
   useEffect(() => {
      if (isClosing) {
